        ...
        <div className="alpine-container">
          ...
          <div className="grid gap-16 mb-12">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <img src={imgPrivate} alt={d("Lezione privata snowboard Dobbiaco", "Privater Snowboardunterricht Toblach", "Private snowboard lesson Dobbiaco")} className="rounded-2xl w-full h-48 object-cover object-top" />
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <img src={imgGroup} alt={d("Corso collettivo snowboard Dobbiaco", "Snowboard Gruppenkurs Toblach", "Snowboard group course Dobbiaco")} className="rounded-2xl w-full h-48 object-cover object-top" />
                  <p className="text-muted-foreground font-body leading-relaxed">
                    {d(

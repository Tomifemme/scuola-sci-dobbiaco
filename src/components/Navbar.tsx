...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-alpine-deep backdrop-blur-lg shadow-lg" : "bg-alpine-deep/95 backdrop-blur-md"} border-b border-primary/20`}>

    ...
    >
      <div className="flex items-center gap-3 bg-destructive/10 border border-destructive/20 rounded-xl px-5 py-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">21.12.26 – 09.01.27 | 31.01.27 – 27.02.27</p>
        </div>
      </div>
      <div className="flex items-center gap-3 bg-primary/10 border border-primary/20 rounded-xl px-5 py-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">28.11.26 – 20.12.26 | 10.01.27 – 30.01.27 | 28.02.27 – 04.04.27</p>
        </div>
      </div>
    </motion.div>
  );

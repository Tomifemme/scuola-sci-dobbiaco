        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="relative rounded-xl overflow-hidden mb-6">
              <img src={instructorsImg} alt={{ it: "Team maestri Scuola Sci Dobbiaco", de: "Skilehrerteam Skischule Toblach", en: "Ski School Dobbiaco instructor team" }[lang]!} <img src={instructorsImg} alt={{ it: "Team maestri Scuola Sci Dobbiaco", de: "Skilehrerteam Skischule Toblach", en: "Ski School Dobbiaco instructor team" }[lang]!} className="w-full h-72 object-cover object-bottom rounded-xl" /> />
            </div>
